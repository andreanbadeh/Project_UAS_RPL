			...
			<table class="table table-borderless">
				<tbody>
					<tr>
						...
						<td class="text-center"><h3>Struk</h3></td>
					...
					<tr>
						<td class="text-center">Jl. Kp Pisang Batu RT.03/RW.04, Karang Raharja, Kec. Cikarang Utara, Kota Bekasi, Jawa Barat 17530</td>
					</tr>
				</tbody>
			</table>
			<hr class="line-top" />
